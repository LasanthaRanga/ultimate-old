...
public class MixCancle implements Initializable,BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/Mix_cancle.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/mix/cancel.fxml"));
        ...
        String s = "/view/buttons/Mix_cancle.fxml";
