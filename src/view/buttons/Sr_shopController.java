 ...
 * @author Sampath
 */
public class Sr_shopController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/sr_shop.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/sr/shop.fxml"));
        ...
        String s = "/view/buttons/sr_shop.fxml";
