 ...
 */
public class Adv_position_regController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/adv_position_reg.fxml", this);
        img_t.setImage(new Image("/grafics/position_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/adv/position_reg.fxml"));
        ...
        String s = "/view/buttons/adv_position_reg.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/position_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/position_w.png"));
    }
