...
public class Vehicle_Bill implements Initializable, BTN{
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/vehicle_bill.fxml", this);
        img_t.setImage(new Image("/grafics/Car_Service_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/mix/vehicle.fxml"));
        ...
        String s = "/view/buttons/vehicle_bill.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/Car_Service_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/Car_Service_w.png"));
    }
