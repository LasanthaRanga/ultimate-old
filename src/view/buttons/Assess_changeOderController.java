 ...
 */
public class Assess_changeOderController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_changeOder.fxml", this);
        img_t.setImage(new Image("/grafics/Remove_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/changeOder.fxml"));
        ...
        String s = "/view/buttons/assess_changeOder.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/Remove_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/Remove_w.png"));
    }
