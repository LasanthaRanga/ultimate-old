 ...
 */
public class Assess_UpdateWarrantController implements Initializable,BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_UpdateWarrant.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/changeData.fxml"));
        ...
        String s = "/view/buttons/assess_UpdateWarrant.fxml";
