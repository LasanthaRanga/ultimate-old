...
public class BookCreate implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/book_create.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/booking/book_create.fxml"));
        ...
        String s = "/view/buttons/book_create.fxml";
