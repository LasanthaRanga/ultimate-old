 ...
 */
public class Sendto_approval_btn implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/sendto_approval_btn.fxml", this);
        img_t.setImage(new Image("/grafics/sendto_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/adv/sendto.fxml"));
        ...
        String s = "/view/buttons/sendto_approval_btn.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/sendto_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/sendto_w.png"));
    }
