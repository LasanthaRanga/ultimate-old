...
public class AssApplicationsList implements Initializable,BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/AssApplicationsList.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/Applications.fxml"));
        ...
        String s = "/view/buttons/AssApplicationsList.fxml";
