...
public class Mix_Bill implements Initializable, BTN{
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/mix_bill.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/mix/mixincome.fxml"));
        ...
        String s = "/view/buttons/mix_bill.fxml";
