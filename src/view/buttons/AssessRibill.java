...
public class AssessRibill implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_Ribill.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/ribill.fxml"));
        ...
        String s = "/view/buttons/assess_Ribill.fxml";
