 ...
 */
public class Adv_application_list implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/adv_application_list.fxml", this);
        img_t.setImage(new Image("/grafics/list_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/adv/applist.fxml"));
        ...
        String s = "/view/buttons/adv_application_list.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/list_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/list_w.png"));
    }
