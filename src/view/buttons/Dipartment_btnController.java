 ...
 */
public class Dipartment_btnController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     modle.StaticViews.getBtnConMap().put("/view/buttons/dipartment_btn.fxml", this);
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/users/dipartment.fxml"));
    ...
    public void setImage() {
        img_t.setImage(new Image("/grafics/building.png"));
    }
