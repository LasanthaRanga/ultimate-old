...
public class PayByBarCode implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/PayByBarCode.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        String s = "/view/buttons/PayByBarCode.fxml";
