...
public class Ass_FixAll implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/ass_fixAll.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/fixAll.fxml"));
        ...
        String s = "/view/buttons/ass_fixAll.fxml";
