 ...
 */
public class Adv_paidlist_btnController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/adv_paidlist_btn.fxml", this);
        img_t.setImage(new Image("/grafics/paid_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/adv/paid.fxml"));
        ...
        String s = "/view/buttons/adv_paidlist_btn.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/paid_b.png"));
    ...
    public void setImage() {
         this.img_t.setImage(new Image("/grafics/paid_w.png"));
    }
