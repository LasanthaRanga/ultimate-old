 ...
 */
public class Assess_ChangeAllocationController implements Initializable,BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_ChangeAllocation.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/allocationChange.fxml"));
        ...
        String s = "/view/buttons/assess_ChangeAllocation.fxml";
