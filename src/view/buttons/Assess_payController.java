 ...
 */
public class Assess_payController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_pay.fxml", this);
        img_t.setImage(new Image("/grafics/PayAss_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/Payment.fxml"));
        ...
        String s = "/view/buttons/assess_pay.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/PayAss_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/PayAss_w.png"));
    }
