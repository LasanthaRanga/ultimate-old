 ...
 * @author Sampath
 */
public class Sr_buildingController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/sr_building.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/sr/building.fxml"));
        ...
        String s = "/view/buttons/sr_building.fxml";
