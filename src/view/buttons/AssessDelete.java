...
public class AssessDelete implements Initializable,BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_Delete.fxml", this);
        img_t.setImage(new Image("/grafics/Delete_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/delete.fxml"));
        ...
        String s = "/view/buttons/assess_Delete.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/Delete_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/Delete_w.png"));
    }
