 ...
 * @author Ranga
 */
public class Assess_HomeController implements Initializable,BTN {
   ...
   @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_Home.fxml", this);
        img_t.setImage(new Image("/grafics/Home_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/HomeAssess.fxml"));
        ...
        String s = "/view/buttons/assess_Home.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/Home_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/Home_w.png"));
    }
