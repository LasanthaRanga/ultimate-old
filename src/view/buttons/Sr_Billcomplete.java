...
public class Sr_Billcomplete implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/sr_billcomplete.fxml", this);
        img_t.setImage(new Image("/grafics/search_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/shoprent/billcomplete.fxml"));
        ...
        String s = "/view/buttons/sr_billcomplete.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/search_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/search_w.png"));
    }
