 ...
 */
public class Assess_changeProcessTypeController implements Initializable,BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        modle.StaticViews.getBtnConMap().put("/view/buttons/assess_changeProcessType.fxml", this);
        img_t.setImage(new Image("/grafics/pay_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/ChangeProcessType.fxml"));
        ...
        String s = "/view/buttons/assess_changeProcessType.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/pay_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/pay_w.png"));
    }
