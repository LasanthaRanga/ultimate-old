 ...
 */
public class SystemSettingsController implements Initializable,BTN {
   ...
   @Override
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/systemSettings.fxml", this);
        img_t.setImage(new Image("/grafics/settings_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/SystemSettings.fxml"));
        ...
        String s = "/view/buttons/systemSettings.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    img_t.setImage(new Image("/grafics/settings_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/settings_w.png"));
    }
