 ...
 */
public class TLMore implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/TL_More.fxml", this);
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/tradelicens/moreDetails.fxml"));
        ...
        String s = "/view/buttons/TL_More.fxml";
