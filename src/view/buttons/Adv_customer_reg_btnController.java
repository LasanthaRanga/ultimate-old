 ...
 */
public class Adv_customer_reg_btnController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/adv_customer_reg_btn.fxml", this);
        img_t.setImage(new Image("/grafics/customer_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/adv/customer_reg.fxml"));
        ...
        String s = "/view/buttons/adv_customer_reg_btn.fxml";

        for (String string : keySet) {
            if (string.equals(s)) {
                try {
                    JFXButton get = modle.StaticViews.getButtonMap().get(string);
                    this.img_t.setImage(new Image("/grafics/customer_b.png"));
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/customer_w.png"));
    }
