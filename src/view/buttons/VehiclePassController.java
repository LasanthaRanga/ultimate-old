 ...
 */
public class VehiclePassController implements Initializable, BTN {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        modle.StaticViews.getBtnConMap().put("/view/buttons/vehiclePass.fxml", this);
        img_t.setImage(new Image("/grafics/Details_w.png"));
    }
    ...
    private void clickOnAction(ActionEvent event) {
        ...
        AnchorPane dashh;
        try {
            dashh = FXMLLoader.load(getClass().getResource("/view/assess/vehiclePass.fxml"));
        ...
        String s = "/view/buttons/vehiclePass.fxml";
    ...
    public void setImage() {
        this.img_t.setImage(new Image("/grafics/Details_w.png"));
    }
