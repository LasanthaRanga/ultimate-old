...
/**
 * SlYesNoDetails5 generated by hbm2java
 */
public class SlYesNoDetails5  implements java.io.Serializable {


     private Integer yesNoStatusId;
     private String yesNoStatusName;

    public SlYesNoDetails5() {
    }

    public SlYesNoDetails5(String yesNoStatusName) {
