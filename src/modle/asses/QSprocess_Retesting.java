...
public class QSprocess_Retesting {
  ...
  //  }
    ...
    static String getAll = "SELECT\n" +
            ...
            "\tAND assessment.idAssessment IN ( SELECT Assessment_idAssessment FROM ass_qstart_copy1 WHERE ass_Qstart_QuaterNumber = 2 AND ass_Qstart_year = 2020 AND ass_Qstart_status = 0 )";
               ...
               // progras.setProgress(pro);
                ...
                while (tyaw.next()) {
                    ...
                    if (qn == 2) {
                      ...
                      //  System.out.println("==========  2   " + tyfa +" - "+ tyfw );
                    }

                    if (qn == 3) {
                        tyfa += tyaw.getDouble("ass_Qstart_LQC_Arreas");
                        tyfw += tyaw.getDouble("ass_Qstart_LQC_Warrant");
                       // System.out.println("==========  3   " + tyfa +" - "+ tyfw );
                    }

                    if (qn == 4) {
                        tyfa += tyaw.getDouble("ass_Qstart_LQC_Arreas");
                        tyfw += tyaw.getDouble("ass_Qstart_LQC_Warrant");
                      //  System.out.println("==========  4   " + tyfa +" - "+ tyfw );
                    }
